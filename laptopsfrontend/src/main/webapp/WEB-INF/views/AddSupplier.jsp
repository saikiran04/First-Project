          ...
          <c:if test="${!empty supplierList }">
           <table class="tg">
            <tr>
             ...
             <tr>
             <td>${supplier.prodid }</td>
             <td>${supplier.prodname }</td>
          <td>${supplier.address }</td>
          <td>${supplier.email }</td>
          <td>${supplier.phone }</td>
         <%-- <td>${product.category.catid }</td>
  <td>${product.supplier.supplierid }</td> --%>
   <td><a href="<c:url value='/editproducts${supplier.supplierid }'/>">Edit</a></td>
   
   <td><a href="<c:url value='/deleteproduct${supplier.supplierid }'/>">Delete</a></td>
   </tr>
   </c:forEach>
